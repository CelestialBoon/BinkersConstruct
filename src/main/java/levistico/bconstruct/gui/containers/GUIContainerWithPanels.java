...
import levistico.bconstruct.mixin.AccessorGuiContainer;
...
public abstract class GUIContainerWithPanels extends GuiContainer {
    ...
    public void drawScreen(int mouseX, int mouseY, float renderPartialTicks) {
        ...
        if (inventoryplayer.getHeldItemStack() != null) {
            ...
            ((AccessorGuiContainer)this).getGuiRenderItem().render(inventoryplayer.getHeldItemStack(), mouseX-8, mouseY-8);
            GL11.glTranslatef(0.0f, 0.0f, -32.0f);
        }
        if(inventoryplayer.getHeldItemStack() == null) {
            for(IPanel panel : panels) {
    ...
    public void drawSlotInventory(Slot slot, boolean isMouseOver) {
        ...
        ((AccessorGuiContainer)this).getGuiRenderItem().render(slot.getStack(), i, j, isMouseOver, slot);
    }
