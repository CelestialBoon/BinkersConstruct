...
//    public static final String TOOL_BITS_TEXTURE = "binkerstoolbits";
    ...
    public static int GUI_CRAFTING_INDEX;
//    public static int guiCounter = 0;
    ...
    public static void importGUITextures() {
        String texturePath = String.format("/assets/%s/gui/icons.png", BConstruct.MOD_ID);
        BufferedImage texture = Textures.readImage(TextureHandler.class.getResourceAsStream(texturePath));
        GUI_ICONS_INDEX = mc.renderEngine.allocateAndSetupTexture(texture);

        texturePath = String.format("/assets/%s/gui/bcrafting.png", BConstruct.MOD_ID);
        texture = Textures.readImage(TextureHandler.class.getResourceAsStream(texturePath));
        GUI_CRAFTING_INDEX = mc.renderEngine.allocateAndSetupTexture(texture);
    }
...
/*
    ...
    */
    ...
    static {
        Utils.setGrow(bitsLocation, EToolBit.BasicHandle.ordinal(), "basic_handle");

        Utils.setGrow(bitsLocation, EToolBit.Hatchet_Binding.ordinal(), "hatchet/binding");
        Utils.setGrow(bitsLocation, EToolBit.Hatchet_Head.ordinal(), "hatchet/head");
        Utils.setGrow(bitsLocation, EToolBit.Hatchet_Head_Broken.ordinal(), "hatchet/head_broken");

        Utils.setGrow(bitsLocation, EToolBit.Mattock_BackHead.ordinal(), "mattock/back_head");
        Utils.setGrow(bitsLocation, EToolBit.Mattock_BackHead_Broken.ordinal(), "mattock/back_head_broken");
        Utils.setGrow(bitsLocation, EToolBit.Mattock_FrontHead.ordinal(), "mattock/front_head");
        Utils.setGrow(bitsLocation, EToolBit.Mattock_FrontHead_Broken.ordinal(), "mattock/front_head_broken");

        Utils.setGrow(bitsLocation, EToolBit.Pickaxe_Binding.ordinal(), "pickaxe/binding");
        Utils.setGrow(bitsLocation, EToolBit.Pickaxe_Head.ordinal(), "pickaxe/head");
        Utils.setGrow(bitsLocation, EToolBit.Pickaxe_Head_Broken.ordinal(), "pickaxe/head_broken");

        Utils.setGrow(bitsLocation, EToolBit.Broadsword_Blade.ordinal(), "sword/blade");
        Utils.setGrow(bitsLocation, EToolBit.Broadsword_Blade_Broken.ordinal(), "sword/blade_broken");
        Utils.setGrow(bitsLocation, EToolBit.Broadsword_Guard.ordinal(), "sword/guard");
        Utils.setGrow(bitsLocation, EToolBit.Broadsword_Handle.ordinal(), "sword/handle");
    }
}
