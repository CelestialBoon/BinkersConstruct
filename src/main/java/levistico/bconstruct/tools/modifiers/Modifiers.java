...
public class Modifiers {
    ...
    public static final ModifierStats DIAMOND = new ModifierStats(1, new StatBoosts()
    ...
    public static final ModifierStats REINFORCED = new ModifierStats(5, new StatBoosts()
