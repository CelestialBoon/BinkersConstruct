...
public class RightClickActions {
    ...
    public static final RightClickAction TILL = new RCAOnWorld(ERCActions.Till.ordinal(), (itemstack, entityPlayer, world, x, y, z, side, xPlaced, yPlaced) -> {
            int i1 = world.getBlockId(x, y, z);
            int j1 = world.getBlockId(x, y + 1, z);
            if (!(side != Side.BOTTOM && j1 == 0 && (i1 == Block.grass.id || i1 == Block.dirt.id || i1 == Block.pathDirt.id || i1 == Block.grassRetro.id))) {
    ...
    public static final RightClickAction REPLANT = new RCAOnWorld(ERCActions.Replant.ordinal(), (itemstack, entityPlayer, world, x, y, z, side, xPlaced, yPlaced) -> {
    ...
    public static final RightClickAction PATH = new RCAOnWorld(ERCActions.Path.ordinal(), (itemstack, entityPlayer, world, x, y, z, side, xPlaced, yPlaced) -> {
        int id = world.getBlockId(x, y, z);
        int idAbove = world.getBlockId(x, y + 1, z);
        if (!(side != Side.BOTTOM && idAbove == 0 && (id == Block.grass.id || id == Block.dirt.id || id == Block.pathDirt.id || id == Block.grassRetro.id))) {
            return Optional.empty();
        }
    ...
    public static final RightClickAction FIRESTRIKER = new RCAOnWorld(ERCActions.Firestriker.ordinal(), (itemstack, entityPlayer, world, x, y, z, side, xPlaced, yPlaced) -> {
        Vec3 b = Utils.getBlockToSide(x, y, z, side);
