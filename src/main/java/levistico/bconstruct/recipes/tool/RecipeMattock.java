...
/*public final class RecipeMattock extends BToolRecipe {
    protected Pair<Boolean, ItemStack> tryCrafting(InventoryCrafting inv) {
        ...
        if(inv.getItemStackAt(0, 0) != null &&
                ...
                inv.getItemStackAt(2, 0).getItem() == Item.flint &&
            ...
            ItemStack mattock = new ItemStack(BTool.mattock);
            mattock.tag = BTool.mattock.constructTags(mattock.tag, new BToolMaterial[]{BToolMaterial.flint, BToolMaterial.flint}, new BToolMaterial[]{}, new BToolMaterial[]{BToolMaterial.wood});
            return new Pair<>(true, mattock);
