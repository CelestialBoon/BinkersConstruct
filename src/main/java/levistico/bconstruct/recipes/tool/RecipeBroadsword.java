...
/*public final class RecipeBroadsword extends BToolRecipe {
    protected Pair<Boolean, ItemStack> tryCrafting(InventoryCrafting inv) {
        ...
        if(inv.getItemStackAt(0, 0) == null &&
                ...
                inv.getItemStackAt(1, 1).getItem() == Item.flint &&
            ...
            ItemStack broadsword = new ItemStack(BTool.broadsword);
            broadsword.tag = BTool.broadsword.constructTags(broadsword.tag, new BToolMaterial[]{BToolMaterial.flint}, new BToolMaterial[]{BToolMaterial.wood}, new BToolMaterial[]{BToolMaterial.wood});
            return new Pair<>(true, broadsword);
