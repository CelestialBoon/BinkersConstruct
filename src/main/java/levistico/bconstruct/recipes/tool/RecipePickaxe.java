...
/*public final class RecipePickaxe extends BToolRecipe {
    ...
    protected Pair<Boolean, ItemStack> tryCrafting(InventoryCrafting inv) {
        ...
        if(inv.getItemStackAt(0, 0) != null &&
            ...
            ItemStack pick = new ItemStack(BTool.pickaxe);
            pick.tag = BTool.pickaxe.constructTags(pick.tag, new BToolMaterial[]{BToolMaterial.flint}, new BToolMaterial[]{BToolMaterial.wood}, new BToolMaterial[]{BToolMaterial.wood});
